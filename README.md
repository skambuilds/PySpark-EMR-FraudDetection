...
- An [AWS S3 bucket](https://docs.aws.amazon.com/AmazonS3/latest/user-guide/create-bucket.html), follow this guide to create an S3 bucket.
  ...
  - From the bucket page you have to create the following list of directories (by clicking on the "Create folder" button, and assign a name to the folder and leave all the rest untauched):
